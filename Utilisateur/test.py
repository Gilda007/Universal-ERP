...
class MaClasse:
    def try_exemple(self):
        def fonction_interne():
            return "Fonction définie à l'intérieur du bloc try"

        try:
            resultat = fonction_interne()
            return resultat
        except Exception as e:
            print("Une erreur s'est produite :", e)

# Création d'une instance de la classe
instance_classe = MaClasse()

# Appel de la fonction try_exemple
