...
from Frontends.Requettes import connexion
...
class Ui_Authentification(object):
    def setupUi(self, Authentification):
        ...
        Authentification.setStyleSheet("\n"
"color: rgb(0, 0, 0);")
        self.centralwidget = QtWidgets.QWidget(Authentification)
        self.centralwidget.setStyleSheet("background-color: #0E9BE1;")
...
"background-color: none;")
    ...
    def retranslateUi(self, Authentification):
        ...
        self.usernameerror.setText(_translate("Authentification", "Utiliateur non existant"))
        self.passworderror.setText(_translate("Authentification", "Utiliateur non existant"))
        self.label_6.setText(_translate("Authentification", "chargement..."))
